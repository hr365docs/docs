...
"</li>" +
       ...
       "<li class='dropdownicon sidelist' title='Users, Roles, Permissions'>" +
        ...
        "<a href='/sharepoint-helpdesk/modern/admin/settings/integration/#email-tracker'>Integrating Mail Tracker with Xdesk 365</a>" +
        "</li>" +
        ...
        "<ul class='sidenavSub-topics '>" +
        "</ul>" +
        "<a href='/sharepoint-helpdesk/modern/admin/settings/features/#RetaindatainHelpdesk365till'>Retain data in Xdesk 365 till days</a>" +
        "</li>" +
