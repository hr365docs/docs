    ...
    "<ul class='sidenavSub-topics aside_dropdown_list_setting'>"+
        ...
        "<li data-nav-id='./User/' title='General' class='sidelist dropdown_romove_dot'>"+
            "<ul class='sidenavSub-topics aside_dropdown_list'>"+
                ...
                "</li>"+
                "<li data-nav-id='./Column-Setting/' title='Date Format' class='sidelist'>"+
                    "<a href='/online-asset-management-application/modern/admin/settings/general/#date-format'>Date Format</a>"+
                "</li>"+
                "<li data-nav-id='./Dashboard-Settings/' title='Asset ID Prefix' class='sidelist'>"+
        ...
        "<li data-nav-id='./Add Assets/' class='sidelist dropdown_romove_dot'>"+
            "<ul class='sidenavSub-topics aside_dropdown_list'>"+
                ...
                "</li>"+
                "<li data-nav-id='./Assign-Assets/ ' title='Allow User to Select Approver' class='sidelist'>"+
                ...
                "</li>"+
                "<li data-nav-id='./Assign-Assets/ ' title='Allow Users to Return Assets' class='sidelist'>"+
        ...
        "<li data-nav-id='./Add Assets/ ' class='sidelist dropdown_romove_dot'>"+
            "<ul class='sidenavSub-topics aside_dropdown_list'>"+
                ...
                "</li>"+
                "<li data-nav-id='./Add Assets/ ' title='Customized Platform Title' class='sidelist'>"+
        ...
        "<li data-nav-id='./Add Assets/ ' class='sidelist dropdown_romove_dot'>"+
            "<ul class='sidenavSub-topics aside_dropdown_list'>"+
                ...
                "</li>"+
                "<li data-nav-id='./Assign-Assets/ ' title='Default camera scanner for edit assets' class='sidelist'>"+
                ...
                "</li>"+
                "<li data-nav-id='./Add Assets/ ' title='Configure-Barcode-Field(s)' class='sidelist'>"+
                ...
                "</li>"+
                "<li data-nav-id='./Add Assets/ ' title='Hide the Assign and Return Assets in Home Page' class='sidelist'>"+
                ...
                "</li>"+
                "<li data-nav-id='./Add Assets/ ' title='Hide/Show Thumbnail' class='sidelist'>"+
                ...
                "</li>"+
                "<li data-nav-id='./Add Assets/ ' title='GCC Tenant' class='sidelist'>"+
                ...
                "</li>"+
                "<li data-nav-id='./Add Assets/ ' title='Inventory Module' class='sidelist'>"+
