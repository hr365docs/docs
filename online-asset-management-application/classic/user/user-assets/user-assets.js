$(document).ready(function() {
    ...
    $("#userasidebar").append(
        ...
        "<a class='qwe' href='/online-asset-management-application/classic/user/userinterface/'> User Interface </a>"+
        ...
        "<ul class='sidenavSub-topics aside_dropdown_list'>"+
          "<li data-nav-id='../General' title='My Assets' class='sidelist'>"+
           "<a href='/online-asset-management-application/classic/user/userinterface/#my-assets'> My Assets </a>"+
            ...
            "<a href='/online-asset-management-application/classic/user/userinterface/#book-assets'> Book Assets </a>"+
             "</li>"+
             "<li data-nav-id='../General' title='Booking Details' class='sidelist'>"+
             "<a href='/online-asset-management-application/classic/user/userinterface/#booking-details'> Booking Details </a>"+
              "</li>"+
              "</ul>"+
               "</li>"+
