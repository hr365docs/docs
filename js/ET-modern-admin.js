    ...
    "<ul class='sidenavSub-topics aside_dropdown_list active'>"+
       ...
       " <ul>"+
           ...
           " <li data-nav-id='./General-Settings/' title='Users, Roles and Permissions' class='sidelist'>"+
            "<a href='/Expense-tracker/modern/admin/settings/#users-roles-permissions'>"+
           " Users, Roles and Permissions"+
            "</a>"+
            "</li>"+
          
           " <li data-nav-id='./Custom-Emails/' title=Integrations class='sidelist'>"+
                "<a href='/Expense-tracker/modern/admin/settings/#integrations'>"+
                "Integrations"+
               " </a>"+
            "</li>"+

            "<li data-nav-id='./Column-Setting/' title=Contract Fields class='sidelist'>"+
           "<a href='/Expense-tracker/modern/admin/settings/#Autonumbering'>"+
           " Auto Numbering"+
           "</a>"+
           "</li>"+

           " <li data-nav-id='./Custom-Emails/' title=Users class='sidelist'>"+
                "<a href='/Expense-tracker/modern/admin/settings/#Generalsetting'>"+
                "General Setting"+
               " </a>"+
            "</li>"+
        //     " <li data-nav-id='./Custom-Emails/' title=Users class='sidelist'>"+
        ...
        // "</li>"+
        " <li data-nav-id='./Custom-Emails/' title=Users class='sidelist'>"+
        "<a href='/Expense-tracker/modern/admin/settings/#Feature'>"+
        "Feature"+
       " </a>"+
    "</li>"+
        
    " <li data-nav-id='./Custom-Emails/' title=Users class='sidelist'>"+
    "<a href='/Expense-tracker/modern/admin/settings/#Contractfiels'>"+
    "Contract Field"+
   " </a>"+
"</li>"+
