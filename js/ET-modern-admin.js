$(document).ready(function () {
    ...
    $("#ETmodernadmin").append("<li data-nav-id='./Settings/' title=Introduction class=sidelist>" +
        ...
        "<a href='/Expense-tracker/modern/admin/settings/general-setting/#CurrencySeperator'> Currency Seperator </a>" +
        "</li>" +
        ...
        "<a href='/Expense-tracker/modern/admin/settings/general-setting/#CustomColumn'> Custom Column </a>" +
        "</li>" +
        "<li data-nav-id='../General' title='Expense Future Days' class='sidelist'>" +
        "<a href='/Expense-tracker/modern/admin/settings/general-setting/#ExpenseFutureDays'> Expense Future Days </a>" +
        "</li>" +
        "<li data-nav-id='../General' title='Display Project Name' class='sidelist'>" +
        "<a href='/Expense-tracker/modern/admin/settings/general-setting/#DisplayProjectName'>Display Project Name</a>" +
        "</li>" +
        "<li data-nav-id='../General' title='Expense Tracking ID' class='sidelist'>" +
        "<a href='/Expense-tracker/modern/admin/settings/general-setting/#ExpenseTrackingID'>Expense Tracking ID</a>" +
        "</li>" +
...
"<li data-nav-id='../General' title='Integration' class='dropdownicon sidelist'>" +
 ...
 "<li data-nav-id='../General' title='Zoho Books Integration' class='sidelist'>" +
        ...
        "<a href='/Expense-tracker/modern/admin/settings/feature/#Expense-Type-Limits'>Expense Type Limits</a>" +
        "</li>" +
        "<li data-nav-id='../General' title='Approver Budget Limit' class='sidelist'>" +
        "<a href='/Expense-tracker/modern/admin/settings/feature/#Approver-Budget-Limit'>Approver Budget Limit</a>" +
        "</li>" +
