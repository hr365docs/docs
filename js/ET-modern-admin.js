$(document).ready(function () {
    ...
    $("#ETmodernadmin").append("<li data-nav-id='./Settings/' title=Introduction class=sidelist>" +
        ...
        "<a href='/Expense-tracker/modern/admin/settings/#themes'>Theme</a>" +
        "</li>" +
        "<li data-nav-id='../General' title='Date format' class='sidelist'>" +
        "<a href='/Expense-tracker/modern/admin/settings/#Dateformat'> Date format </a>" +
        "</li>" +
        "<li data-nav-id='../General' title='Currency' class='sidelist'>" +
        "<a href='/Expense-tracker/modern/admin/settings/#Currency'> Currency </a>" +
        "</li>" +
        "<li data-nav-id='../General' title='Currency Seperator' class='sidelist'>" +
        "<a href='/Expense-tracker/modern/admin/settings/#CurrencySeperator'> Currency Seperator </a>" +
        "</li>" +
        "<li data-nav-id='../General' title='Language' class='sidelist'>" +
        "<a href='/Expense-tracker/modern/admin/settings/#Language'> Language </a>" +
        "</li>" +
        "<li data-nav-id='../General' title='Custom Column' class='sidelist'>" +
        "<a href='/Expense-tracker/modern/admin/settings/#CustomColumn'> Custom Column </a>" +
        "</li>" +
        "<li data-nav-id='../General' title='Expense Future Days' class='sidelist'>" +
        "<a href='/Expense-tracker/modern/admin/settings/#ExpenseFutureDays'> Expense Future Days </a>" +
        "</li>" +
        "<li data-nav-id='../General' title='Display Project Name' class='sidelist'>" +
        "<a href='/Expense-tracker/modern/admin/settings/#DisplayProjectName'>Display Project Name</a>" +
        "</li>" +
        "<li data-nav-id='../General' title='Expense Tracking ID' class='sidelist'>" +
        "<a href='/Expense-tracker/modern/admin/settings/#ExpenseTrackingID'>Expense Tracking ID</a>" +
        "</li>" +
        "<li data-nav-id='../General' title='Sharepoint Page Configuration:' class='sidelist'>" +
        "<a href='/Expense-tracker/modern/admin/settings/#SharepointPageConfiguration'> Sharepoint Page Configuration </a>" +
        "</li>" +

        "</ul>" +
        "<li data-nav-id='../General' title='Sharepoint Page Configuration:' class='sidelist'>" +
        "<a class='qwe' href='/Expense-tracker/modern/admin/settings/#UserPermissions'>  User Roles and Permissions</a>" +
        "</li>" +
        "</li>" +
        "<li data-nav-id='../General' title='Sharepoint Page Configuration:' class='sidelist'>" +
        ...
        "<a href='/Expense-tracker/modern/admin/settings/#Custom-Fields'> Custom Fields</a>" +
        "</li>" +
        "<li data-nav-id='../General' title='Cost Center' class='sidelist'>" +
        "<a href='/Expense-tracker/modern/admin/settings/#Cost-Center'>Cost Center</a>" +
        "</li>" +
        "<li data-nav-id='../General' title='Departments' class='sidelist'>" +
        "<a href='/Expense-tracker/modern/admin/settings/#Department'>Departments</a>" +
        "</li>" +
        "<li data-nav-id='../General' title='Job Title' class='sidelist'>" +
        "<a href='/Expense-tracker/modern/admin/settings/#Job-title'>Job Title</a>" +
        "</li>" +
