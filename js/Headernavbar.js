...
$(".navbar-nav.ml-auto").append("<li class='nav-item'>"+
              "<a class='nav-link text-dark homelink' href='https://hr365docs.github.io/docs/'>Home</a>"+
            "</li>");
...
// $(".navbar-nav.ml-auto").append("<li class='nav-item'>"+
// "<a class='nav-link text-dark' href='"+ linkref+"/sharepoint-employee-directory/'>Employee Directory</a>"+
// "</li>");
