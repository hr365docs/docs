$(document).ready(function() {
    ...
    $("#obm-modern-user").append(
        ...
        " <li data-nav-id='./installation/requirments/' title=Introduction class=sidelist>"+
         ...
         "<li data-nav-id='./installation/requirments/' title=Home_Page class=sidelist>"+
         "<a href='/sharepoint-employee-onboarding/modern/user/homepage/'> Home Page </a>"+
         "</li>"+
         
     
         "<li class='dropdownicon sidelist'>"+
         "<a class='qwe'  href='/sharepoint-employee-onboarding/modern/user/userinterface/'> User Interface </a>"+
         ...
         "<ul class='sidenavSub-topics aside_dropdown_list'>"+
          ...
          "<a href='/sharepoint-employee-onboarding/modern/user/userinterface/#update-profiles'> Update Profiles </a>"+
           "</li>"+
           "<li data-nav-id='../General' title=' Update Details' class=sidelist>"+
            "<a href='/sharepoint-employee-onboarding/modern/user/userinterface/#update-details'> Update Details </a>"+
             "</li>"+
             "<li data-nav-id='../General' title='Upload Documents' class=sidelist>"+
              "<a href='/sharepoint-employee-onboarding/modern/user/userinterface/#upload-documents'> Upload Documents </a>"+
              "</li>"+
              "</ul>"+
              "</li>"+
              "</li>"+
