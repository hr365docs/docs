$(document).ready(function() {
    $("#obm-modern-admin").html("");
     $("#obm-modern-admin").append(
        ...
        "<a href='/sharepoint-employee-onboarding/modern/admin/set-up-of-application/system-setting/#email-template'> Email Template </a>"+
        "</li>"+
        "<li data-nav-id='../General' title='Document Settings ' class=sidelist>"+
        "<a href='/sharepoint-employee-onboarding/modern/admin/set-up-of-application/system-setting/#document-settings'> Document Settings </a>"+
        "</li>"+
        "<li data-nav-id='../General' title=' Advance settings' class=sidelist>"+
        "<a href='/sharepoint-employee-onboarding/modern/admin/set-up-of-application/system-setting/#advance-settings'> Advance settings </a>"+
        "</li>"+
        "<li data-nav-id='../General' title='Quick Share Links' class=sidelist>"+
        "<a href='/sharepoint-employee-onboarding/modern/admin/set-up-of-application/system-setting/#quick-share-links'> Quick Share Links </a>"+
        "</li>"+
