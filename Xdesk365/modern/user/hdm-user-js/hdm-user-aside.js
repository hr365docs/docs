$(document).ready(function() {
    ...
    "<a href='/Xdesk365/modern/user/introduction/'>Introduction</a>"+
    "</li>"+
    
    "<li data-nav-id='./Home-Page/' title='Home Page'  class='sidelist'>"+
    "<a href='/Xdesk365/modern/user/home-page/'>Home Page</a>"+
    "</li>"+

    "<li data-nav-id='../getting-started/' title='Theme' class='sidelist'>"+
    "<a href='/Xdesk365/modern/user/theme/'>Theme</a>"+
    "</li>"+
    "<li data-nav-id='./User-Interface/' title='Help' class='sidelist'>"+
    "<a href='/Xdesk365/modern/user/help/'>Help</a>"+
    "</li>");
})