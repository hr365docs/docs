$(document).ready(function () {
    ...
    $("#hdm-admin-aside").append(
       ...
       "<li data-nav-id='./Settings/' title='Settings'  class='sidelist dropdown_romove_dot'>"+
        ...
        "<li data-nav-id='./General' title='General' class='dropdownicon sidelist'>"+
...
"</li>"+
"<li data-nav-id='./Setting/' title='General' class='sidelist dropdown_romove_dot'>"+
...
"</li>"+
// "<li data-nav-id='../General' title='Weekly Basis, Select Day' class='sidelist'>"+
// "<a href='/online-timesheet-software/modern/admin/settings/notification/#Send-Pending-Timesheet-Approval-Notification'>Weekly Basis, Select Day</a>"+
// "</li>"+
// "<li data-nav-id='../General' title='Monthly Basis, Select Date' class='sidelist'>"+
// "<a href='/online-timesheet-software/modern/admin/settings/notification/#Send-Pending-Timesheet-Approval-Notification'>Monthly Basis, Select Date</a>"+
// "</li>"+
